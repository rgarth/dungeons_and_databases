...
export function getStartingEquipment(characterClass: string, background: string): string[] {
  // Note: Equipment packs are now handled separately via database (/api/equipment-packs)
  // This function only provides individual class and background items
  
  const classEquipment: Record<string, string[]> = {
    Barbarian: ['Greataxe', 'Handaxe', 'Handaxe', 'Javelin', 'Javelin', 'Javelin', 'Javelin', 'Leather Armor'],
    Bard: ['Rapier', 'Leather Armor', 'Dagger', 'Lute'],
    Cleric: ['Scale Mail', 'Shield', 'Warhammer', 'Light Crossbow'],
    Druid: ['Leather Armor', 'Shield', 'Scimitar'],
    Fighter: ['Chain Mail', 'Shield', 'Light Crossbow'],
    Monk: ['Shortsword', 'Dart', 'Dart', 'Dart', 'Dart', 'Dart', 'Dart', 'Dart', 'Dart', 'Dart', 'Dart'],
    Paladin: ['Chain Mail', 'Shield', 'Javelin', 'Javelin', 'Javelin', 'Javelin', 'Javelin'],
    Ranger: ['Scale Mail', 'Shield', 'Shortsword', 'Shortsword', 'Longbow'],
    Rogue: ['Leather Armor', 'Shortsword', 'Shortsword', 'Shortbow', 'Arrow (20)', 'Thieves Tools'],
    Sorcerer: ['Light Crossbow', 'Dagger', 'Dagger'],
    Warlock: ['Light Crossbow'],
    Wizard: ['Quarterstaff', 'Dagger', 'Light Crossbow', 'Spellbook']
  };
