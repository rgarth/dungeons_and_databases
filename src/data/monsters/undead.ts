...
export const undeadMonsters: Monster[] = [
  ...
  },
  {
    ...
    "traits": [
      ...
      {
        "name": "Spellcasting",
        "description": "The lich is an 18th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 20, +12 to hit with spell attacks).\n\n🎯 COMBAT SPELLS\n• Ray of Frost (cantrip): 1d8 cold damage, 60ft range, -10ft speed\n• Magic Missile (1st): 3d4+3 force damage, 120ft range, auto-hit\n• Fireball (3rd): 8d6 fire damage, 20ft radius, Dex save DC 20\n• Cloudkill (5th): 5d8 poison damage, 20ft radius, Con save DC 20\n• Disintegrate (6th): 10d6+40 force damage, Dex save DC 20\n• Finger of Death (7th): 7d8+30 necrotic damage, Con save DC 20\n• Power Word Kill (9th): Kill target with 100 HP or less\n\n🛡️ DEFENSIVE SPELLS\n• Shield (1st): +5 AC as reaction to being hit\n• Mirror Image (2nd): 3 illusory duplicates, 1 minute\n• Globe of Invulnerability (6th): Immune to 5th level and below spells\n• Power Word Stun (8th): Stun target with 150 HP or less\n\n⚡ UTILITY SPELLS\n• Counterspell (3rd): Counter enemy spell, DC 20\n• Dimension Door (4th): Teleport 500ft with willing creature\n• Scrying (5th): Remote viewing of target\n• Plane Shift (7th): Transport to another plane\n• Dominate Monster (8th): Control any creature, Wis save DC 20"
      },
      {
  ...
  },
  {
    ...
    "traits": [
      ...
      {
        "name": "Spellcasting",
        "description": "The mummy lord is a 10th-level spellcaster. Its spellcasting ability is Wisdom (spell save DC 17, +9 to hit with spell attacks).\n\n🎯 COMBAT SPELLS\n• Sacred Flame (cantrip): 1d8 radiant damage, 60ft range, Dex save DC 17\n• Guiding Bolt (1st): 4d6 radiant damage, 120ft range, +2d6 on next attack\n• Spiritual Weapon (2nd): 1d8+4 force damage, bonus action attack\n• Insect Plague (5th): 4d10 piercing damage, 20ft radius, Con save DC 17\n• Harm (6th): 14d6 necrotic damage, reduce HP max, Wis save DC 17\n\n🛡️ DEFENSIVE SPELLS\n• Shield of Faith (1st): +2 AC for 10 minutes\n• Guardian of Faith (4th): 60 HP guardian that attacks enemies\n\n⚡ UTILITY SPELLS\n• Command (1st): Force target to obey one-word command, Wis save DC 17\n• Hold Person (2nd): Paralyze humanoid, Wis save DC 17\n• Silence (2nd): 20ft radius of silence\n• Animate Dead (3rd): Create undead servants\n• Dispel Magic (3rd): End magical effects, DC 17\n• Contagion (5th): Inflict disease, Con save DC 17"
      }
    ],
    "actions": [
      {
