...
--
-- Name: CustomWeapon; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."CustomWeapon" (
    id text NOT NULL,
    name text NOT NULL,
...
--
-- Name: CustomWeapon CustomWeapon_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: CustomWeapon_creatorId_name_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Character Character_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: CustomWeapon CustomWeapon_creatorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
